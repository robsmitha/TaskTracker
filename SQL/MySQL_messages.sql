...
CREATE TABLE `smithadb`.`messages` (
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_messages_Load`
(
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_messages_LoadAll`()
BEGIN
	SELECT
		`messages`.`MessageID` AS `MessageID`,
		`messages`.`Description` AS `Description`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_messages_Add`
(
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_messages_Update`
(
	IN paramMessageID INT,
	IN paramDescription VARCHAR(255),
	IN paramSenderAccountID INT,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_messages_Delete`
(
	IN paramMessageID INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_messages_Search`
(
	IN paramMessageID INT,
	IN paramDescription VARCHAR(255),
	IN paramSenderAccountID INT,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_messages_LoadByRecipientAccountID`
(
